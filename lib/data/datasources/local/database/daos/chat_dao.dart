...
class ChatDao extends DatabaseAccessor<AppDatabase> with _$ChatDaoMixin {
  ...
  Future<List<ChatMessagesTableData>> getMessagesForSession(
          int sessionId) =>
  ...
  Future<List<ChatSessionsTableData>> getSessionsForUser(
          String userId) =>
