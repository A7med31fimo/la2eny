...
class PlaceCard extends StatelessWidget {
  ...
  Widget _imagePlaceholder() => Container(
        ...
        child: const Center(
          child: Icon(Icons.place, color: AppColors.textTertiary, size: 40),
        ),
      );
          ...
          Row(
            children: [
              ...
              if (place.distanceKm != null)
                Row(
                  children: [
                    const Icon(Icons.near_me, size: 12, color: AppColors.textTertiary),
                    const SizedBox(width: 2),
                    Text(
                      Haversine.formatDistance(place.distanceKm!),
  ...
  Widget _priceBadge() {
    return Row(
      children: List.generate(4, (i) => Text(
            '＄',
            style: AppTextStyles.labelSmall.copyWith(
              color: i < place.priceLevel ? AppColors.priceActive : AppColors.priceInactive,
            ),
          )),
    );
  }

  Widget _openNowBadge() => Container(
